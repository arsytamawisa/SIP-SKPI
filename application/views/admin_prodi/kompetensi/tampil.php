                        ...
                        <tbody>
                            ...
                            <?php foreach ($kompetensi as $key => $value): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url("admin_prodi/kompetensi/hapus/$value[id_kompetensi]") ?>" class="btn btn-danger danger-icon-notika waves-effect pull-right hapus" data-toggle="tooltip" data-placement="bottom" title="Hapus Data">
                                            <i class="fa fa-trash"></i>
                                        </a>
                                        <button style="margin-right:20px" type="button" data-toggle="modal" title="Edit Kompetensi" data-target="#<?= $key ?>" class="btn btn-success success-icon-notika btn-reco-mg btn-button-mg pull-right">
    ...
    <div class="modal fade" id="myModal1" role="dialog">
        <div class="modal-dialog modal-default">
            <div class="modal-content">
                ...
                <?php $admin_prodi = $this->session->userdata('admin_prodi') ?>
                <input type="hidden" name="id_program_studi" value="<?= $admin_prodi['id_program_studi'] ?>">
