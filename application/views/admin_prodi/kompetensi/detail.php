                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6 col-xs-6">
                            <div class="button-icon-btn button-icon-btn-cl">
                                <a href="<?= base_url("admin_prodi/kompetensi") ?>" data-toggle="tooltip" data-placement="bottom" title="Kembali" class="btn btn-danger danger-icon-notika btn-reco-mg btn-button-mg pull-right">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($sub_kompetensi as $key => $value): ?>
                                    <tr>
                                        ...
                                        <td width="15%">
                                            <button class="btn btn-success success-icon-notika waves-effect" data-toggle="modal" data-target="#<?= $key ?>" data-placement="bottom" title="Update Data">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            &emsp;
                                            <a href="<?= base_url("admin_prodi/kompetensi/hapus_sub/$value[id_sub_kompetensi]") ?>" class="btn btn-danger danger-icon-notika waves-effect hapus" data-toggle="tooltip" data-placement="bottom" title="Hapus Data">
