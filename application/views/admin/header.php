                            ...
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#datamaster" href="#">Data Master</a>
                                    <ul id="datamaster" class="collapse dropdown-header-top">
                                        <li><a href="<?= base_url('admin/perguruan_tinggi') ?>">Perguruan Tinggi</a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="<?php if($this->uri->segment('2') == 'dashboard') { echo "active" ;} ?>">
                            <a href="<?= base_url('admin/dashboard') ?>"><i class="notika-icon notika-house"></i> Home</a>
                        </li>

                        <?php $admin = $this->session->userdata('admin') ?>

                        <!-- Jika Role Super Admin -->
                        <?php if ($admin['role'] == "Super Admin"): ?>
                            <li>
                                <a data-toggle="tab" href="#master"><i class="notika-icon notika-form"></i> Data Master</a>
                            </li> 
                            <li>
                                <a data-toggle="tab" href="#petugas"><i class="notika-icon notika-form"></i> Data Petugas</a>
                            </li>     
                        <?php endif ?>

                        <!-- Jika Role Penerjemah -->
                        <?php if ($admin['role'] == "Penerjemah"): ?>
                            <li class="<?php if($this->uri->segment('2') == 'penerjemah') { echo "active" ;} ?>">
                                <a href="<?= base_url('admin/penerjemah') ?>"><i class="notika-icon notika-edit"></i> Penerjemah</a>
                            </li>
                        <?php endif ?>
                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Page" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li>
                                    <a href="<?= base_url('admin/ganti_password') ?>"> Ganti Password </a>
                                </li>
                                |
                                <li>
                        ...
                        <div id="master" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li>
                                    <a href="<?= base_url('admin/perguruan_tinggi') ?>"> Perguruan Tinggi </a>
                                </li>
                                |
                                <li>
                                    <a href="<?= base_url('admin/fakultas') ?>"> Fakultas </a>
                                </li>
                                |
                                <li>
                                    <a href="<?= base_url('admin/prodi') ?>"> Program Studi </a>
                                </li>
                                |
                                <li>
                                    <a href="<?= base_url('admin/tahun_angkatan') ?>"> Tahun Angkatan </a>
                                </li>                              
                            </ul>
                        </div>
                        <div id="petugas" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li>
                                    <a href="<?= base_url('admin/petugas_prodi') ?>"> Petugas Prodi </a>
                                </li>
                                |
                                <li>
                                    <a href="<?= base_url('admin/petugas_penerjemah') ?>"> Penerjemah </a>
                                </li>                           
                            </ul>
                        </div>
                    </div>
