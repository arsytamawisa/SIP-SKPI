			...
			<table width="100%">
				<tbody>
					...
					<?php foreach ($info as $key => $value): ?>
						...
						if($value['tgl_mulai'])
						{
							$oldformat      = str_replace("/","-",$value['tgl_mulai']);
							$time           = strtotime($value['tgl_mulai']);
						...
						<?php } else { ?>
							...
							<tr class="isi">
								...
								<td><?= $key+1 ?>.</td>
								<td width="47%">
									<?php if(!empty($value['status'])) {echo $value['status'].", ";} ?>
									<?php if(!empty($value['kegiatan'])) {echo $value['kegiatan'].", ";} ?>
									<?php if(!empty($value['penyelenggara'])) {echo $value['penyelenggara'].", ";} ?>
									<?php if($tgl_mulai) 
									{
										if (empty($tgl_selesai)) 
										{
											echo tanggal_indo($tgl_mulai).", ";
										}
										else
										{
											if($tgl_selesai) 
								...
								<td><?= $key+1 ?>.</td>
								<td>
									<?php if ( !empty($value['activity']) || !empty($value['activity']) || !empty($value['activity']) ) 
									{ 
										...
										if(!empty($value['activity'])) {echo $value['activity'].", ";}

										if(!empty($value['institution'])) {echo $value['institution'].", ";}

										if($tgl_mulai) 
										{
											if(empty($tgl_selesai)) 
											{
												echo tanggal_luar($tgl_mulai).", ";
											}
											else
											{
												if($tgl_selesai) 
			...
			<table width="100%">
				<tbody>
					<tr>
						...
						<td class="pull-right">Yogyakarta, <?= date_now($date_now) ?></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="pull-right">( <?= $mahasiswa['nama_dekan'] ?> )</td>
					</tr>
					<tr>
